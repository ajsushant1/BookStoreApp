...
import com.bridgelabz.bookstoreapp.mailsender.model.UserDetails;
...
public class MailServiceImpl implements IMailService {
    ...
    @Override
    public void sendMail(UserDetails userDetails) throws MessagingException {
        MimeMessage message = javaMailSender.createMimeMessage();
        MimeMessageHelper helper = new MimeMessageHelper(message, true);
        helper.setSubject("Thank you for registering");
        helper.setTo(userDetails.getEmail());
        helper.setText("Dear " + userDetails.getName() + ",\n" +
                "\n" +
